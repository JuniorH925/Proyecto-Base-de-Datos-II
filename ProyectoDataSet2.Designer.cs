...
namespace ProyectoBDD.ProyectoDataSet2TableAdapters {
...
SELECT id_venta, id_producto, cantidad, codigo_cliente, nombre, direccion, correo, nit FROM Ventas WHERE (id_venta = @id_venta)";
        ...
        public virtual int Fill(ProyectoDataSet2.VentasDataTable dataTable) {
        ...
        public virtual ProyectoDataSet2.VentasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ProyectoDataSet2.VentasDataTable dataTable = new ProyectoDataSet2.VentasDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ProyectoDataSet2.VentasDataTable dataTable) {
